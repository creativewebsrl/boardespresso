        ...
        password :{
            ...
            everyauth: {
              ...
              authenticate: function (login, password) {
                ...
                UserModel.authenticate(login, password, function (err, user) {
                    var response = ['errors'];
                    var errors = response;
                    ...
                    if (user) {
                        ...
                        UserModel.count({'login':login},function(err,count){
                            if (count) {
              ...
              validateRegistration: function (newUserAttrs) {
                ...
                var UserModel = this.User()();
                UserModel.count({'login':data.login},function(err,count){
                    if (count) {
                        errors.login = "Username not available";
                        promise.fulfill(response);
                    } else {
                        
                        UserModel.count({'email':data.email},function(err,count){
                            if (count) {
              ...
              respondToLoginSucceed: function(res, user, data) {
                data.req.session.user_id = user.id;
                res.redirect(this.postLoginPath(), 301);
              }
